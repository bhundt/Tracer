...
class Matrix4ArichtmeticTest: XCTestCase {
    // p. 26
...
//        var M = Matrix4(rows: 3, columns: 3)
...
//
//        var R = Matrix4(rows: 2, columns: 2)
//        R[0, 0] = -3; R[0, 1] = 2
//        R[1, 0] = 0; R[1, 1] = 6
//
...
//
//        var R = Matrix4(rows: 3, columns: 3)
...
//        var A = Matrix4(rows: 3, columns: 3)
//        A[0, 0] = 3; A[0, 1] = 5; A[0, 2] = 0
//        A[1, 0] = 2; A[1, 1] = -1; A[1, 2] = -7
//        A[2, 0] = 6; A[2, 1] = -1; A[2, 2] = 5
//
...
//    }
    ...
    func roundMatrix(M: Matrix4, digits: Double) -> Matrix4 {
        var out = Matrix4()
